...
Class UsuarioGrupo extends BaseModelPKComposta{
    ...
    public static function VisualizarUsuariosGrupo(Request $request){
        return self::GeraVisualizacaoRelacao('usuario_id', 'grupo_id',
        User::query()->orderBy('id')->get(['id', 'name', 'email', 'path_avatar']), Grupo::query()->orderBy('id')->get(['id', 'nome']),
        'usuario','grupos');
    }
}